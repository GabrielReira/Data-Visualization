from dash import Dash, html, callback, Output, Input, dcc, register_page
import pandas as pd
import pathlib
import os
...
layout = html.Div([
  ...
  dcc.Graph(figure=px.line(data["BTC"], x="timestamp", y="adjclose"), id="crypto-graph2")
])

# Controls and callbacks
@callback(
  Output("crypto-graph2", "figure"),
